...
- В BLOCK активный `trigger` задаёт источник сообщения, запускающего проверку; остальные источники могут быть условиями без самостоятельного запуска. При `EVERY` (включённой бесконечности) каждое новое подходящее сообщение может повторно выполнить ветку без изменения результата условия; `ONCE` ограничивает такой повтор до изменения результата. [SprutHub Wiki о триггерах, oldid 738](https://wiki.spruthub.ru/index.php?title=%D0%A2%D1%80%D0%B8%D0%B3%D0%B3%D0%B5%D1%80%D1%8B_%D0%B2_%D1%81%D1%86%D0%B5%D0%BD%D0%B0%D1%80%D0%B8%D1%8F%D1%85_(%D0%B6%D0%B5%D0%BB%D1%82%D1%8B%D0%B5_%D0%BA%D1%80%D1%83%D0%B6%D0%BE%D1%87%D0%BA%D0%B8)&oldid=738). Официальный [frontend asset](https://beta.spruthub.ru/js/app.16735171810a795a9f2d.js), SHA-256 `81c1ef74ce21eb5ccff583255ba82fe766ff4cf6bc251c0566b7bd67436647f8`, связывает кнопку Infinity с native `EVERY`/`ONCE`; это mapping интерфейса, а семантику задаёт Wiki.
