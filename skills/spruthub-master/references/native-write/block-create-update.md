...
- Для повторяющегося дневного/ночного режима поддержан один native `interval` в
  ...
  поддерживаются. Упоминание ночи само по себе не требует расписания: при
  незаданных часах источник режима выбирай по [карточке «Режим дома»](../engineering-practices.md#режим-дома)
  до prepare; interval — когда границы задал владелец или выбранный источник
  именно часы.
