  ...
  "prepare_native_change",
  {
    ...
    inputSchema: {
      ...
      endpoint_ref: z
        ...
        .optional()
        .describe(
          "Home-qualified physical characteristic reference required for virtual_light_link",
        ),
