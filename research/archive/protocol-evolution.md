...
> Архив архитектурного черновика. Текущий объём работ — в [README](../../README.md).
> Описанный pipeline не реализован; сроки и дополнительные слои не являются обязательствами.
